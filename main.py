...
out_dir = 'result/h{}_z{}_lr{}_beta{}'.format(args.h_dim, args.z_dim, args.learning_rate, args.beta)
...
def test(epoch):
    ...
    for batch_idx, (data, _) in enumerate(test_loader):
        ...
        if batch_idx == 0:
            comparison = torch.cat([data.view(args.batch_size, 1, 28, 28)[:8],
                                    outs['x_dist'].probs.view(args.batch_size, 1, 28, 28)[:8]])
